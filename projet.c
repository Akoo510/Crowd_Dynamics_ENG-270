...
int main(void){
    ...
    while((test_1_sheep.posX != test_1_cage.exitX)&&(test_1_sheep.posY != test_1_cage.exitY)){
        pathFinding(&test_1_sheep.posX, &test_1_sheep.posY, test_1_cage.exitX, test_1_cage.Y, test_1_sheep.speed);
